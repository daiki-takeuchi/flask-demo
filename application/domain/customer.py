...
class Customer(db.Model):
    ...
    def __init__(self,
        ...
        self.address_line1 = address_line1 or None
        self.address_line2 = address_line2 or None
        self.city = city or None
        self.state = state or None
        self.postal_code = postal_code or None
        self.country = country or None
        self.sales_rep_employee_number = sales_rep_employee_number or None
        self.credit_limit = credit_limit or None
